...
🖥️ Deployed on Somee.com 

📁 Image upload support 

🌍 Multi-language ready responses (EN / AR)
...
📅 Event management API (CRUD for Admins)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
🛠️ Technologies Used 
ASP.NET Core 9/ Entity Framework SQL Server/ JWT (JSON Web Token) for authentication /Swagger for API documentation
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
